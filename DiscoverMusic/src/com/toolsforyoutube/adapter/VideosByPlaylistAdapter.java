...
public class VideosByPlaylistAdapter extends BaseAdapter {
	...
	public VideosByPlaylistAdapter(Activity a, List<SearchVideoItem> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView views = (TextView)vi.findViewById(R.id.tv_views_count_value); // title
		//		TextView likes = (TextView)vi.findViewById(R.id.tv_ratig_value); // title
		//		TextView duration = (TextView)vi.findViewById(R.id.tv_duration_value); // title
		//		TextView published = (TextView)vi.findViewById(R.id.tv_published_value); // title
		...
		//		likes.setText(channel.getVideo_likes());
